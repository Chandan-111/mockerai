...
function RecordAnswerSection({mockInterviewQuestion, activeQuestionIndex, interviewData}) {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-2'>
      ...
      <Button 
        variant="outline" 
        className='frosted-button-dark mt-4 w-40 border-white/20 hover:bg-white/20' 
        onClick={SaveUserAnswer}
      >
        {listening ? 'Stop Recording' : 'Start Recording'}
      </Button>
        <Button variant="outline" className='frosted-button-dark mt-2 w-40 border-white/20 hover:bg-white/20' onClick={() => {
          resetTranscript();
          setUserAnswer('');
        }}>Reset</Button>
