      ...
      <div className='flex items-center justify-center'>
       ...
       <div>
        ...
        <Alert variant="destructive">
          <AlertCircleIcon />
          <AlertTitle >I saw that you turned off the camera</AlertTitle>
          <AlertDescription>
            Don't worry we won't share your video with anyone <p>
              Turn it on
            </p>
          </AlertDescription>
        </Alert>
...
{webCamEnabled === true && (
  <Alert variant="default">
    ...
    <Button className='w-135 my-2' >Start Interview</Button>
    </Link>
  </Alert>
)}
       </div>
